...
def main(
    ...
    val_loader = DataLoader(validation_ds, batch_size=10, shuffle=True)
    ...
    for epoch in range(1, 10):
        ...
        logger.info(f"epoch {epoch:02d} train_loss_avg={train_loss_avg:.4f} val_loss_avg={val_loss_avg:.4f}")
